...
class Trainer(object):
    ...
    def train(self):
        ...
        for step in range(1, self.num_steps + 1):
            ...
            #self.env.render() # Comment out to not see progression
            ...
            if step % self.eval_interval == 0:
                ...
                self.algo.save_models(
                    os.path.join(self.model_dir, 'step %d' % step))
    ...
    def evaluate(self, step):
        ...
        print("Num steps: {}, Return: {}, Time: {}".format(step, mean_return, self.time))
